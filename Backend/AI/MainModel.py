...
# === Config ===
INPUT_FILE = "../Documents/clean_llm_detector_Konst/output_queue.json"
...
# === Clean LLM output to remove unnecessary formatting ===
...
print(f"\nā Explanations written to '{OUTPUT_FILE}'")
print(f"š§  Cache saved to '{CACHE_FILE}'")