...
└─ src/
   ...
   ├─ explanation-constans.js
   ├─ universal-message-parser.js
   ├─ main-body.js
   ├─ index.js                      # Exports new components
   ├─ setup-tab.js                  # Configuration interface  
   ├─ explanations-tab.js           # Explanations management
   ├─ chat-box.js                   # Direct AI chat interface
   ├─ status-bar.js                 # Server status and microphone status 
   └─ status-bar.test.ja            # Test file for the according status bar
```
